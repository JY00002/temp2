...
model.add(Dense((4096), activation='relu', name='dense0', kernel_initializer='he_normal'))
model.add(Dropout(dr))
model.add(Reshape((64,64,1)))
model.add(Conv2D(128, (8, 8), activation='relu', name='conv1', padding='same', kernel_initializer='glorot_uniform'))
model.add(Dropout(dr))
...
model.add(Dropout(dr))
model.add(AveragePooling2D(pool_size=(2, 2), strides=None, padding='valid', data_format=None))
model.add(Conv2D(64, (4, 4), activation='relu', name='conv5', padding='same', kernel_initializer='glorot_uniform'))
model.add(Dropout(dr))
model.add(Flatten())
...
model.add(Dropout(dr))
model.add(Dense(90, name='dense3', kernel_initializer='he_normal'))
